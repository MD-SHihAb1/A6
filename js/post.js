...
const displayPost = posts =>{
    ...
    posts.forEach(post =>{
        ...
        postTitle.classList = `card card-compact w-[40%] bg-base-100 shadow-xl ml-52`
        postTitle.innerHTML = `
        <div class="avatar">
        ...
        <div class="card-body">
          ...
          <h1 class"font-semibold text-5xl">${post.title}</h1>
          <p class"text-4xl">${post.description}</p>
          <h1 class"font-semibold text-5xl">
          <div class="avatar">
  <div class="w-8 rounded flex">
